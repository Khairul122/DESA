...
<body class="bg-dark">
		...
		<navbar class="navbar navbar-expand-lg navbar-dark bg-info">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
				<ul class="navbar-nav ml-auto mt-lg-3 mr-5 position-relative text-right">
					...
					<li class="nav-item active">
						<a class="nav-link" href="http://localhost/Desa/register.php">REGISTRASI</a>
					</li>
				...
				<div class="card-body">
					<div class="card-text">
						<p>
							...
							<hr>
						<blockquote>
							Web Aplikasi untuk pelayanan surat administrasi desa yang dikembangkan oleh <b><a href="https://www.instagram.com/ellafiska02_/" style="text-decoration:none">ellafiskayanti</a></b> untuk mempermudah staff pelayanan dan penduduk dalam pembuatan surat administrasi desa.
							<br>
							<br>
						</blockquote>
						</p>
						...
						<hr>
						<b>©</b> e-<b>SuratDesa</b> 2025. Hak Cipta Dilindungi.
					</div>
					<br><br><br>
					<div class="row text-center">
						<div class="col-md-12">
							<img src="../assets/img/" class="img-circle"><br><br>
							<p class="text-muted">Trademark By <b><a href="#" style="text-decoration:none">ellafiskayanti</a></b></p>
						</div>
	...
	<div class="footer bg-dark text-center">
		<span class="text-light"><strong>Copyright &copy; 2025 <a href="../" class="text-decoration-none text-white">e-SuratDesa</a>.</strong> All rights reserved.</span>
	</div>
</body>
