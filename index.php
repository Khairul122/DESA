...
<body>
	...
	<div class="container" style="max-height:cover; padding-top:50px; padding-bottom:120px" align="center">
		<img src="assets/img/logo-agam1.png" width="25%">
		<hr>
		...
		?>
			<a class="text-light" style="font-size:15pt; text-transform: uppercase;"><strong>KENAGARIAN <?php echo $row['nama_desa']; ?></strong><br>
				<a class="text-light" style="font-size:15pt; text-transform: uppercase;"><strong><?php echo $row['kabupaten']; ?></strong></a>
				<hr>
			<?php
		}
			?>
