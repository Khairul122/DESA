						...
						<div class="row">
						  	<div class="col-sm-12">
						        ...
						        <div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="text" name="falamat_usaha" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Alamat Lengkap Usaha (Jalan, Nomor, RT/RW, Desa, Kecamatan, Kota)" required>
						           	</div>
						        </div>
						      	<div class="form-group">
