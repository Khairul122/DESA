					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="container-fluid">
								<div class="row">
									<a class="col-sm-6">
										<h5><b>SURAT KETERANGAN PINDAH</b></h5>
									</a>
									<a class="col-sm-6">
							...
							<form method="post" action="simpan-surat.php">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label class="col-sm-12" style="font-weight: 500;">Jumlah Keluarga Yang Pindah</label>
											<div class="col-sm-12">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label class="col-sm-12" style="font-weight: 500;">Alamat Tujuan Pindah</label>
											<div class="col-sm-12">
												<input type="text" name="falamat_pindah" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Keperluan Surat" required>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
