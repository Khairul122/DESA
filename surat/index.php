...
<body class="bg-light">
	...
	<div class="container-fluid">
		<div style="padding-top:30px; padding-bottom:60px; position:relative; min-height: 50%;">
			<div class="row justify-content-center">
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KTP SEMENTARA</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KETERANGAN</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KETERANGAN BERKELAKUAN BAIK</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KETERANGAN DOMISILI</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KETERANGAN KEPEMILIKAN KENDARAAN BERMOTOR</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KETERANGAN USAHA</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT PENGANTAR SKCK</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KETERANGAN TIDAK MAMPU</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT KETERANGAN LAHIR</h5>
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
					<div class="card text-center">
						<img src="../assets/img/logo_surat.png" class="card-img-top w-50 mx-auto d-block" alt="Logo Surat">
						<div class="card-body">
							<h5 class="card-title text-truncate">SURAT PENGANTAR PINDAH</h5>
	...
	<div class="footer bg-dark text-center">
		<span class="text-light"><strong>Copyright &copy; 2025 <a href="../" cla s="text-decoration-none text-white">e-SuratDesa</a>.</strong> All rights reserved.</span>
	</div>
</body>
