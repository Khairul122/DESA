        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Pengantar Pindah</h2>
              ...
              <form class="form-horizontal" method="post" action="update-konfirmasi.php">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          $qCekNoSurat = mysqli_query($connect, "SELECT no_surat FROM surat_pengantar_pindah WHERE no_surat LIKE '%SPP-$tahun_sekarang' ORDER BY no_surat DESC LIMIT 1");
                          ...
                          if (mysqli_num_rows($qCekNoSurat) > 0) {
                            ...
                            $nomorUrut++;
                            $nomorSuratBaru = "140/" . sprintf("%02d", $nomorUrut) . "/SPP-" . $tahun_sekarang;
                          } else {
                            $nomorSuratBaru = "140/01/SPP-" . $tahun_sekarang;
                          }
                          ?>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="box-body">
                      ...
                      <div>
                        <input type="hidden" name="id" value="<?php echo $row['id_pp']; ?>" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Jumlah Keluarga Yang Pindah</label>
                        <div class="col-sm-9">
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Alamat Tujuan Pindah</label>
                        <div class="col-sm-9">
                          <input type="text" name="falamat_pindah" style="text-transform: capitalize;" value="<?php echo $row['alamat_pindah']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  </div>
