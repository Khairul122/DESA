                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          $qCekNoSurat = mysqli_query($connect, "SELECT no_surat FROM surat_pengantar_SKCK WHERE no_surat LIKE '%SPSKCK-$tahun_sekarang' ORDER BY no_surat DESC LIMIT 1");
                          ...
                          if (mysqli_num_rows($qCekNoSurat) > 0) {
                            ...
                            $nomorUrut++;
                            $nomorSuratBaru = "140/" . sprintf("%02d", $nomorUrut) . "/SPSKCK-" . $tahun_sekarang;
                          } else {
                            $nomorSuratBaru = "140/01/SPSKCK-" . $tahun_sekarang;
                          }
                          ?>
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <select name="fmasa_berlaku" class="form-control" >
