                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          $qCekNoSurat = mysqli_query($connect, "SELECT no_surat FROM surat_keterangan_kepemilikan_kendaraan_bermotor WHERE no_surat LIKE '%SKKKB-$tahun_sekarang' ORDER BY no_surat DESC LIMIT 1");
                          ...
                          if (mysqli_num_rows($qCekNoSurat) > 0) {
                            ...
                            $nomorUrut++;
                            $nomorSuratBaru = "140/" . sprintf("%02d", $nomorUrut) . "/SKKKB-" . $tahun_sekarang;
                          } else {
                            $nomorSuratBaru = "140/01/SKKKB-" . $tahun_sekarang;
                          }
                          ?>
