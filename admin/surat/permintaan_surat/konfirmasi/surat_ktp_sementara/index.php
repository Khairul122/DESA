                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          $qCekNoSurat = mysqli_query($connect, "SELECT no_surat FROM surat_ktp_sementara WHERE no_surat LIKE '%SKS-$tahun_sekarang' ORDER BY no_surat DESC LIMIT 1");
                          ...
                          if (mysqli_num_rows($qCekNoSurat) > 0) {
                            ...
                            $nomorSuratBaru = "140/01/SKS-" . $tahun_sekarang;
                          }
                          ?>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="box-body">
                      ...
                      <div>
                        <input type="hidden" name="id" value="<?php echo $row['id_ks']; ?>" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
