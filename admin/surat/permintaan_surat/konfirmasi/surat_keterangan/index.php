                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          $qCekNoSurat = mysqli_query($connect, "SELECT no_surat FROM surat_keterangan WHERE no_surat LIKE '%SK-$tahun_sekarang' ORDER BY no_surat DESC LIMIT 1");
                          ...
                          if (mysqli_num_rows($qCekNoSurat) > 0) {
                            ...
                            $nomorUrut++;
                            $nomorSuratBaru = "140/" . sprintf("%02d", $nomorUrut) . "/SK-" . $tahun_sekarang;
                          } else {
                            $nomorSuratBaru = "140/01/SK-" . $tahun_sekarang;
                          }
                          ?>
                      ...
                      <div class="box-body">
                        <div class="form-group">
                          <div class="col-sm-offset-3 col-sm-9">
                            <input type="hidden" name="id" value="<?php echo $row['id_sk']; ?>">
