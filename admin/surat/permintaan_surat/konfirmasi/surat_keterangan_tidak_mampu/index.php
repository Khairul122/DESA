                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          $qCekNoSurat = mysqli_query($connect, "SELECT no_surat FROM surat_keterangan_tidak_mampu WHERE no_surat LIKE '%SKS-$tahun_sekarang' ORDER BY no_surat DESC LIMIT 1");
