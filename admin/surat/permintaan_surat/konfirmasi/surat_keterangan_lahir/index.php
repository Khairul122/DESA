        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Keterangan Lahir</h2>
            ...
            <div class="box-body">
              <form class="form-horizontal" method="post" action="update-konfirmasi.php">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          $qCekNoSurat = mysqli_query($connect, "SELECT no_surat FROM surat_keterangan_lahir WHERE no_surat LIKE '%SKL-$tahun_sekarang' ORDER BY no_surat DESC LIMIT 1");
                          ...
                          if (mysqli_num_rows($qCekNoSurat) > 0) {
                            ...
                            $nomorUrut++;
                            $nomorSuratBaru = "140/" . sprintf("%02d", $nomorUrut) . "/SKL-" . $tahun_sekarang;
                          } else {
                            $nomorSuratBaru = "140/01/SKL-" . $tahun_sekarang;
                          }
                          ?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <h5 class="box-title" style="color: #696969; margin-top: 20px; margin-bottom: 10px;">
                      <i class="fas fa-info-circle"></i> <b>Informasi Penduduk</b>
                    </h5>
                    <hr style="border-bottom: 1px solid #DCDCDC; margin-top: 10px; margin-bottom: 20px;">
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fnama_ibu" style="text-transform: capitalize;" value="<?php echo $row['nama_ibu']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Nama Anak</label>
                        <div class="col-sm-9">
                          <input type="text" name="fnama_bayi" style="text-transform: capitalize;" value="<?php echo $row['nama_bayi']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                      <?php
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fanak_ke" style="text-transform: uppercase;" value="<?php echo $row['anak_ke']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <input type="hidden" name="id" value="<?php echo $row['id_skl']; ?>">
                    <div class="box-body" style="text-align: right; padding-right: 15px;">
