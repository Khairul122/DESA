			...
			<body>
				<div>
					...
					<div id="isi3">
						...
						<table width="100%">
							<tr>
								<td class="indentasi">Orang tersebut diatas benar-benar penduduk kami <a style="text-transform: capitalize;">, Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kabupaten']; ?></a></td>
							</tr>
						</table><br>
						<table width="100%">
							<tr>
