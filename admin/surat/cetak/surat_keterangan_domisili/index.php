			...
			<body>
				<div>
					...
					<div id="isi3">
						...
						<table width="100%">
							<tr>
								<td class="indentasi">Bahwa benar-benar penduduk kami<a style="text-transform: capitalize;">, Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kabupaten']; ?></a>. Bahwa nama yang bersangkutan berdomisili di <a style="text-transform: capitalize;"><b><?php echo $row['jalan'] . ", RT" . $row['rt'] . "/RW" . $row['rw'] . " " . $row['desa'] . ", Kecamatan " . $row['kecamatan'] . ", " . $row['kabupaten']; ?></b></a>.</td>
							</tr>
						</table><br>
						<table width="100%">
							<tr>
