			...
			<body>
				<div>
					...
					<div id="isi3">
						...
						<table width="100%">
							<tr>
								<td class="indentasi">Benar nama tersebut diatas warga desa kami, menurut keterangan ketua RT/RW setempat dan sepengetahuan kami bahwa yang bersangkutan adalah termasuk : <strong>Keluarga Tidak Mampu</strong><a style="text-transform: capitalize;">, Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?> <?php echo $rows['kabupaten']; ?></a>. Bahwa nama yang bersangkutan tidak berada di rumah dan tidak diketahui keberadaannya.</td>
							</tr>
						</table><br>
						<table width="100%">
							<tr>
						...
						<table width="100%">
							<tr>
								<td class="indentasi">Demikian surat keterangan ini kami buat dengan sebenarnya, dan kepada pihak yang berkepentingan agar dapat mengetahui dan mohon bantuannya.</td>
							</tr>
						</table>
					</div>
					<br>
