			...
			<body>
				<div>
					...
					<div id="isi3">
						...
						<table width="100%">
							<tr>
								<td class="indentasi">Keterangan : Nama tersebut diatas benar penduduk desa kami, Kartu Tanda Penduduk (KTP) atas nama tersebut diatas sedang dalam proses. <a style="text-transform: capitalize;"> Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kabupaten']; ?></a>. Bahwa nama yang bersangkutan tidak berada di rumah dan tidak diketahui keberadaannya.</td>
							</tr>
						</table><br>
						<table width="100%">
							<tr>
