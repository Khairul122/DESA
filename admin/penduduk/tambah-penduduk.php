      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fas fa-user-plus"></i> Formulir Data Diri</h3>
              ...
              <form class="form-horizontal" method="post" action="simpan-penduduk.php">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="fkabupaten" class="form-control" style="text-transform: capitalize;" placeholder="Kabupaten" required>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="fstatus_dlm_keluarga" class="form-control" required>
                          ...
                          <option value="Ayah">Kepala Keluarga</option>
                  ...
                  <div class="box-footer pull-right">
                    ...
                    <a href="http://localhost/Desa/admin/dashboard/" class="btn btn-info">Kembali</a>
                  </div>
                </div>
              </form>
            </div>
