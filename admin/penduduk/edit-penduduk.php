                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="fkabupaten" class="form-control" style="text-transform: capitalize;" placeholder="Kabupaten" value="<?php echo $row['kabupaten']; ?>" required>
                        </div>
                      </div>
                    </div>
                  </div>
